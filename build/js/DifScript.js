...
function showQuestions (index){
    qH_esay.textContent = quDif[index].qus
    let opstions_tag = '<button class="p-1 opstion_tag  text-gray-600 font-bold text-left bg-gray-300 border border-solid border-gray-500 w-[100%] rounded-md flex flex-row items-center justify-between">' + quDif[index].options[0] + '</button>'
    + '<button class="p-1 opstion_tag text-gray-600 font-bold text-left bg-gray-300 border border-solid border-gray-500 w-[100%] rounded-md flex flex-row items-center justify-between">' + quDif[index].options[1] + '</button>'
    + '<button class="p-1 opstion_tag text-gray-600 font-bold text-left bg-gray-300 border border-solid border-gray-500 w-[100%] rounded-md flex flex-row items-center justify-between">' + quDif[index].options[2] + '</button>'
...
function optionSelected(answer){
    ...
    let correctAns = quDif[que_count].answer
